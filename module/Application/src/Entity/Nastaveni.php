...
/**
 * Application\Entity\Nastaveni
 *
 * @ORM\Entity(repositoryClass="Application\Repository\NastaveniRepository")
 * @ORM\Table(name="Nastaveni", indexes={@ORM\Index(name="fk_Admins_user1_idx", columns={"user_id"})})
 */
class Nastaveni
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="User", inversedBy="nastaveni")
     ...
     * @return \Application\Entity\Nastaveni
     */
    ...
    {
        return array('id_admins', 'jmeno', 'heslo', 'umisteni', 'email', 'telefon', 'cele_jmeno', 'last_online', 'user_id');
    }
}