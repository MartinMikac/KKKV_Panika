 ...
 * @ORM\Table(name="Onlines", indexes={@ORM\Index(name="fk_Onlines_Admins1_idx", columns={"Admins_id_admins"})}, uniqueConstraints={@ORM\UniqueConstraint(name="id_online", columns={"idOnline"})})
 */
class Online
{
    /**
    ...
    /**
     * Set the value of idOnline.
     *
     * @param integer $idOnline
     * @return \Application\Entity\Online
     */
    public function setIdOnline($idOnline)
    {
    ...
    {
        return array('idOnline', 'Admins_id_admins', 'status', 'cas_prihlaseni', 'cas_refresh');
    }
}