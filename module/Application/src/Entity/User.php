...
class User
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Nastaveni", mappedBy="user")
     */
    protected $nastaveni;
    ...
    public function __construct()
    {
        ...
        $this->nastavenis = new ArrayCollection();
    ...
    /**
     * Set Nastaveni entity (one to one).
     *
     * @param \Application\Entity\Nastaveni $nastaveni
     * @return \Application\Entity\User
     */
    public function setNastaveni(Nastaveni $nastaveni = null)
    {
        $nastaveni->setUser($this);
    ...
    /**
     * Get Nastaveni entity (one to one).
     *
     * @return \Application\Entity\Nastaveni
     */
    public function getNastaveni()
    {
